          ...
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="text-xs text-gray-500">
                <span class="font-mono">{{ v.vin }}</span> · {{ v.color }}
                <span v-if="v.improntaFolio" class="ml-2 px-1.5 py-0.5 bg-blue-50 text-blue-600 rounded text-[10px] font-bold">{{ v.improntaFolio }}</span>
              </p>
          ...
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="text-xs text-gray-400 mt-0.5">
                ...
                <span v-if="v.inventarioResultado" class="ml-1">· {{ v.inventarioResultado.aprobados }}/{{ v.inventarioResultado.totalItems }} OK</span>
              </p>
            </div>
          </div>
