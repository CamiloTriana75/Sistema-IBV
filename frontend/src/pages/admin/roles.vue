          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
              <div :class="['w-10 h-10 rounded-lg flex items-center justify-center', role.iconBg]">
                <span v-html="role.icon" class="w-5 h-5" />
              </div>
              <div>
            ...
            <div class="flex gap-1">
              <button @click="editRole(role)" class="p-1.5 text-gray-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition">
