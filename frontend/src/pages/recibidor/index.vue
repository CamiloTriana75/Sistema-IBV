...
to="/recibidor/escaneo"
      ...
      <div class="flex gap-2 flex-wrap">
        <span
v-for="cont in contStore.contenedores.filter(c => c.estado !== 'completado')" :key="cont.id"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-6">
      <div class="flex flex-col sm:flex-row gap-3">
        <div class="flex-1 relative">
          ...
          <input
v-model="search" type="text" placeholder="Buscar por folio, VIN, placa, marca..."
...
:to="`/recibidor/impronta?id=${imp.id}`"
                  ...
                  <NuxtLink
:to="`/recibidor/impronta-print?id=${imp.id}`" target="_blank"
