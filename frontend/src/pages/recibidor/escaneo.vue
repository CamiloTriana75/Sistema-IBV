<template>
  <div>
    ...
    <div v-if="paso === 1" class="max-w-2xl mx-auto">
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
        ...
        <div class="mt-8 pt-6 border-t border-gray-100">
          ...
          <div class="space-y-2">
            <button v-for="cont in contenedoresPendientes" :key="cont.id" @click="seleccionarContenedor(cont)"
    ...
    <div v-if="paso === 2 && contenedorActual" class="space-y-6">
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
        <div class="flex flex-wrap items-center gap-5">
          ...
          <button @click="paso = 1; contenedorActual = null"
      ...
      <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div class="xl:col-span-2 space-y-6">
          ...
          <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="divide-y divide-gray-50">
              <div v-for="(veh, idx) in contenedorActual.vehiculos" :key="veh.vin"
                ...
                <!-- Acción -->
                <NuxtLink v-if="veh.escaneado && !veh.improntaId"
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-center mb-4">
              <div class="relative w-28 h-28">
                <svg class="w-28 h-28 transform -rotate-90">
                  ...
                  <circle cx="56" cy="56" r="48" :stroke="progresoVehiculos === 100 ? '#22c55e' : '#3b82f6'"
          ...
          <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
            ...
            <textarea v-model="observaciones" rows="4" placeholder="Notas sobre la recepción..."
          ...
          <!-- Botones -->
          <div class="space-y-3">
            <button @click="finalizarRecepcion" :disabled="vehiculosEscaneados === 0"
    ...
    <Transition enter-active-class="transition duration-300 ease-out" enter-from-class="translate-y-2 opacity-0"
      ...
      <div v-if="toast.show" class="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 py-3 rounded-xl shadow-lg text-white font-medium"
