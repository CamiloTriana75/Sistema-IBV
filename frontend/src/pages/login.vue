...
const features = [
  { icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2', label: 'Registro de impronta con captura fotográfica' },
  { icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', label: 'Checklist de inventario por categorías' },
  { icon: 'M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12v.01M12 4h.01M4 4h4v4H4V4zm12 0h4v4h-4V4zM4 16h4v4H4v-4z', label: 'Despacho por escaneo QR secuencial' },
]
...
<template>
  <div class="min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 relative overflow-hidden flex-col justify-between p-12">
      ...
      <div class="relative space-y-6">
        <h2 class="text-4xl font-black text-white leading-tight">
          Gestión inteligente<br/>de vehículos
        </h2>
        <p class="text-primary-200 text-lg leading-relaxed">
          Controla todo el ciclo de vida de los vehículos desde la recepción hasta el despacho final.
        </p>
      ...
      <div class="relative">
        <p class="text-primary-300 text-xs font-semibold uppercase tracking-widest mb-3">Roles del sistema</p>
        <div class="flex flex-wrap gap-2">
          <span
v-for="rol in roles" :key="rol"
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-gray-50">
      <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/60 p-8 sm:p-10 border border-gray-100">
          <div class="mb-8">
          ...
          <!-- Error -->
          <div v-if="error" class="flex items-center gap-3 p-4 bg-red-50 border border-red-200 rounded-2xl mb-5 text-red-700 text-sm font-medium">
...
v-model="form.email" type="email" required autocomplete="email"
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
v-model="form.password" :type="showPass ? 'text' : 'password'" required autocomplete="current-password"
                  placeholder="••••••••"
                ...
                <button
type="button" class="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-gray-600 transition"
...
type="submit" :disabled="loading"
          ...
          <div class="mt-6 pt-6 border-t border-gray-100">
            <p class="text-xs text-gray-400 font-semibold uppercase tracking-wider mb-3 text-center">Credenciales de prueba</p>
            <div class="grid grid-cols-1 gap-1.5">
              <button
v-for="demo in demoCredentials" :key="demo.email"
                type="button"
                ...
                @click="fillDemo(demo)">
                <span class="font-semibold text-gray-600 group-hover:text-primary-700">{{ demo.email }}</span>
                <span class="text-gray-400 group-hover:text-primary-500 font-medium">{{ demo.label }} →</span>
              </button>
            </div>
            <p class="text-center text-xs text-gray-400 mt-2">Contraseña: <span class="font-bold text-gray-600">ibv2024</span></p>
          </div>
        </div>
      </div>
    </div>
