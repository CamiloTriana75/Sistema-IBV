...
import { j as joinRelativeURL, e as useRuntimeConfig, f as getResponseStatusText, h as getResponseStatus, i as defineRenderHandler, k as getQuery, c as createError, l as getRouteRules, m as joinURL, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Sistema de gestión de inventario y despacho de vehículos en bodegas"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Sistema IBV - Inventario y Despacho de Vehículos"};
